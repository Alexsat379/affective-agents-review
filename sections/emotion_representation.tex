...
\begin{itemize}
    \item Intensidad emocional.
    \item Expresión afectiva.
    \item Valoración social de emociones.
    \item Interpretación contextual.
    \item Normas culturales.
\end{itemize}
